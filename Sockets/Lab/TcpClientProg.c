/*
    ...
    the client. Using remote sockets in connected mode.
*/
...
int main(int argc, char *argv[])
{
    ...
    bcopy((char *)server->h_addr_list[0], (char *)&serv_addr.sin_addr.s_addr, server->h_length); // Use h_addr_list[0] instead of h_addr
